export const exampleSessions = {
  "c40406bc-7123-4230-bc51-a1c8529b026c": {
    patientList: [
      {
        fullUrl:
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:29.996+00:00",
            source: "#J471SHm1v9vaDhxA",
            profile: [
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.052+00:00",
            source: "MANUAL#vjh28mbbPbJNwfxj",
            profile: [
          ...
          identifier: [
            {
              system:
                "https://www.edifecs.com/fhir/CodeSystems/unique-member-id",
              value: "H13936781",
            },
            {
              use: "usual",
    ...
    priorityList: [
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.454+00:00",
            source: "#4sqq9lO3V9ie4vcG",
            profile: [
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.503+00:00",
            source: "#V5Y9rxIroSH0N96r",
            profile: [
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.555+00:00",
            source: "#uOWLrlsi4f1wHCi9",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/pct-gfe-Institutional",
            ],
          },
    ...
    practitionerRoleList: [
      {
        ...
        meta: {
          versionId: "1",
          lastUpdated: "2022-09-23T14:55:31.377+00:00",
          source: "#GHmOBUDu34yYIont",
          profile: [
    ...
    practitionerList: [
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.107+00:00",
            source: "#xZxoCijLMA8yKv3s",
            profile: [
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.140+00:00",
            source: "#lxVTd6T9YUbcOeB7",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-practitioner",
            ],
          },
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.172+00:00",
            source: "#h3q1iLRNa1MwjFv7",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-practitioner",
            ],
          },
    ...
    organizationList: [
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:29.720+00:00",
            source: "#JmphE1YyQLqsYuW5",
            profile: [
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:29.866+00:00",
            source: "#X7ltP267CG3rPf47",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-organization",
            ],
          },
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:29.900+00:00",
            source: "#8GDYLcRjEDJwqNTm",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-organization",
            ],
          },
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:29.927+00:00",
            source: "#Am2AD6MJQMAydfon",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-organization",
            ],
          },
      ...
      },
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:29.957+00:00",
            source: "#cTv8OrrUMeL4ykGA",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-organization",
            ],
          },
    ...
    locationList: [
      {
        ...
        resource: {
          ...
          meta: {
            versionId: "1",
            lastUpdated: "2022-09-23T14:55:31.357+00:00",
            source: "#ZcbrNydDy7ifjwj7",
            profile: [
              "http://hl7.org/fhir/us/davinci-pct/StructureDefinition/davinci-pct-location",
            ],
          },
    ...
    subjectInfo: {
      ...
      selectedCoverage: {
        ...
        meta: {
          versionId: "1",
          lastUpdated: "2022-09-10T06:13:50.231+00:00",
          source: "#Tnoz41Tyr3Ss2SOe",
          profile: [
      ...
      selectedPatientName: "Eve Betterhalf",
      selectedSubmitter: "Submitter-Org-1",
      selectedSubmittingProviderName: "Organization - GFE Service Help INC.",
    },
    gfeInfo: {
      "39924849-7d97-4932-b796-b8b3154acd69": {
        careTeamList: [
          {
            id: "b26f0e7f-18b9-4112-9359-be00e7d6e5ff",
            role: "Rendering",
        ...
        diagnosisList: [
          {
            id: "8358ca52-6516-4ac3-9ea6-eb963a7dc412",
        ...
        procedureList: [
          {
            id: "76025e81-beef-4138-b9e2-553ecbf396f3",
          },
        ],
        claimItemList: [
          {
            id: "f6a5f376-a8e0-47eb-8c80-2e9b3053eb42",
            quantity: 1,
            productOrService:
              "70551: Magnetic resonance (eg, proton) imaging, brain (including brain stem)",
            unitPrice: 266,
            estimatedDateOfService:
              "Mon Sep 26 2022 00:00:00 GMT-0400 (Eastern Daylight Time)",
      ...
      "42553168-6de2-4f3d-b72e-e5fd4f93bbdc": {
        careTeamList: [
          {
            id: "3b0f1c55-0c81-45a5-a835-302831ee2c9f",
            role: "Rendering",
        ...
        diagnosisList: [
          {
            id: "6bbbbd41-8a5d-428f-a067-b4d48f8511e5",
            diagnosis: "S06.3 Focal traumatic brain injury",
            type: "Reason for visit",
          },
        ],
        procedureList: [
          {
            id: "58ebbdfa-e6b9-4197-86ad-186578d6155c",
          },
        ],
        claimItemList: [
          {
            id: "8250da6b-c635-4826-8e5c-c94f73fcf1bf",
            quantity: 1,
            productOrService: "J9312: Injection, rituximab, 10 mg",
            unitPrice: 50,
            estimatedDateOfService:
              "Fri Sep 23 2022 00:00:00 GMT-0400 (Eastern Daylight Time)",
    ...
    selectedGFE: "42553168-6de2-4f3d-b72e-e5fd4f93bbdc",
